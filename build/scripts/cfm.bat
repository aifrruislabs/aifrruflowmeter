...
@rem ##########################################################################
@rem
@rem  cfm startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute cfm
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CFM_OPTS%  -classpath "%CLASSPATH%" aifrru.flowmeter.ifm.Cmd %CMD_LINE_ARGS%
...
:fail
rem Set variable CFM_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CFM_EXIT_CONSOLE%" exit 1
exit /b 1
