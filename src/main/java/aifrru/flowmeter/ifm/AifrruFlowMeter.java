...
import aifrru.flowmeter.jnetpcap.BasicPacketInfo;
import aifrru.flowmeter.jnetpcap.FlowGenerator;
import aifrru.flowmeter.jnetpcap.PacketReader;

public class AifrruFlowMeter {

	public static final Logger logger = LoggerFactory.getLogger(AifrruFlowMeter.class);
	public static void main(String[] args) {
		...
		logger.info("");
		logger.info("AifrruFlowMeterV2 found: {} Files.",pcapfiles.length);
