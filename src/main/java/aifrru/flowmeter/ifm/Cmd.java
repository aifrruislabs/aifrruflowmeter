...
import aifrru.flowmeter.jnetpcap.*;
import aifrru.flowmeter.jnetpcap.worker.FlowGenListener;
...
import static aifrru.flowmeter.Sys.FILE_SEP;
...
public class Cmd {
    ...
    public static void main(String[] args) {
        ...
        if (in.isDirectory()) {
            ...
            if (!SwingUtils.isPcapFile(in)) {
                ...
                logger.info("AifruFlowMeter received 1 pcap file");
    ...
    private static void readPcapDir(File inputPath, String outPath, long flowTimeout, long activityTimeout) {
        ...
        System.out.println(String.format("AifruFlowMeter found :%d pcap files", file_cnt));
